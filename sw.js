// SM Miras Calculator — Service Worker v17
// Self-hosted fonts cached for full offline use
// v17: About section final polish — intro paragraph and Note now fully
// justified (text-align:justify) instead of left-aligned; removed the
// duplicated Developer/Researcher & Developer heading pair — now a single
// "Researcher & Developer" heading followed by name/affiliation once;
// removed the redundant WhatsApp link (same number as the phone link) —
// contact row now shows just phone and email. Calculation engine unaffected
// — re-verified via 64-case regression suite.

const CACHE = 'sm-miras-v17';

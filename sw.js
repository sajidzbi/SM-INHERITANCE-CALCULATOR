// SM Miras Calculator — Service Worker v8
// اس فائل کو HTML فائل کے ساتھ ایک ہی folder میں رکھیں

const CACHE = 'sm-miras-v8';

// فائلیں جو cache ہوں گی — تمام آف لائن
const CACHE_URLS = [
  './',
  './index.html',
  './sw.js',
...
self.addEventListener('fetch', event => {
  ...
  // Only handle same-origin requests (all fonts/resources are local)
  if (!isOrigin) return;
